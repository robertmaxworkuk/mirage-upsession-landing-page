...
export const EVENT = {
  ...
  description:
    "Rodèz и Mirage приглашают студентов топовых вузов отметить окончание сессии и ворваться в лето в пляжно-дискотечной атмосфере. Авторский бар, лофт с диджеями и мировыми хитами, летняя веранда, интерактивные зоны, приглашённые гости, новые знакомства и незабываемые эмоции.",
